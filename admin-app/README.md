# Campus 360 Admin PDF

Dashboard web Next.js pour gerer les PDF de Campus 360.
...
Le flux mobile revient dans l'application avec `campus-360://reset-password`. Pour envoyer les
