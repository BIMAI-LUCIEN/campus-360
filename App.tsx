...
const onboardingStorageKey = 'campus-360.onboarding-seen';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handleAuthLink = (url: string | null) => {
      if (!url || !url.startsWith('campus-360://reset-password')) return;
      ...
      <View style={styles.shell}>
        <View style={[styles.topBar, narrowScreen && styles.topBarCompact]}>
          <View style={styles.headerBrand}>
            ...
            <Text style={styles.appName} numberOfLines={1}>Campus 360</Text>
          </View>
          <Pressable 
        ...
        {isSessionRestoring ? (
          <View style={{ flex: 1, backgroundColor: '#0F172A', justifyContent: 'center', alignItems: 'center', gap: 16 }}>
            ...
            <Text style={{ color: '#94A3B8', fontSize: 14, fontWeight: '600' }}>Chargement de Campus 360...</Text>
          </View>
        ) : !hasSeenOnboarding ? (
                ...
                <View style={[styles.dashboardHeroContent, { width: '100%' }]}>
                  <View style={[styles.flex, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', width: '100%' }]}>
                    <View style={styles.dashboardHeroText}>
                      <Text style={[styles.dashboardEyebrow, { fontSize: 14, color: '#64748B', textTransform: 'none', fontWeight: '500' }]}>👋 Bienvenue sur Campus 360</Text>
              ...
              <View style={styles.accountSurface}>
                <View style={[styles.accountHeroRow, narrowScreen && styles.accountHeroRowCompact]}>
                  ...
                  <View style={styles.flex}>
                    ...
                    <Text style={[styles.accountSurfaceTitle, { fontSize: 22, fontWeight: '700' }]}>{studentProfile?.name ?? 'Etudiant Campus 360'}</Text>
          ...
          <View style={styles.accountHeader}>
            ...
            <View style={styles.flex}>
              <Text style={styles.cardTitle}>
                {studentProfile?.name ?? 'Etudiant Campus 360'}
              </Text>
